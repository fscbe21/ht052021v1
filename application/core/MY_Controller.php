...
class MY_Controller extends CI_Controller {
    ...
    protected function can_quality_check() {
        if ($this->login_user->is_admin || get_array_value($this->login_user->permissions, "quality_check") == "1") {
            return true;
        }
    }
    ...
    protected function get_team_members_dropdown($is_filter = false) {
        ...
        if ($is_filter) {
            $team_members_dropdown = array(array("id" => "", "text" => "- " . lang("employee") . " -"));
        }
