...
class Attendance extends MY_Controller {
    ...
    function clock_in_department_data(){

        $view_data["department_dropdown"]=$this->Department_model->get_details()->result();


        $this->load->view('attendance/clock_in_department_data', $view_data);
    ...
    function log_time($user_id = 0) {
        ...
        $this->Attendance_model->log_time($user_id ? $user_id : $this->login_user->id, $note,$department);
