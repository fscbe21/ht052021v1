...
class Client_approval extends MY_Controller {
    ...
    function index() {
        ...
        $this->template->rander("client_approval/index", $view_data);
    }
    ...
    function modal_form() {
        ...
        $this->load->view('client_approval/modal_form', $view_data);
    }
    ...
    function list_data() {
        ...
        $options = array(
            ...
            "leads_only" => true, 
            "status" => 5,
            "role_id" => $this->login_user->role_id,
    ...
    private function _make_row($data, $custom_fields) {
        ...
        if(! $this->login_user->is_admin){
            $row_data[] = modal_anchor(get_uri("leads/make_client_modal_form/") . $data->id, "<i class='fa fa-check'></i> ", array("class" => "btn btn-primary lead-to-client-button", "title" => "Approve"));
        }else{

            $roleData = $this->Roles_model->get_one($data->last_approved);
            $rolename = $roleData->title;
            $row_data[] = modal_anchor(get_uri("leads/make_client_modal_form/") . $data->id, "<i class='fa fa-check'></i> ", array("class" => "btn btn-primary lead-to-client-button", "title" => "Approve"))."<br /><br /><span style='background-color: green; color:white'>".$rolename."</span>";
        }
