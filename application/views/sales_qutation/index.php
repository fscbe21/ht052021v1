<div id="page-content" class="m20 clearfix">
    ...
    <div class="panel">
            ...
            <div class="tab-title clearfix">
                <h4><?php echo "Sales Quotation"; ?></h4>
                <div class="title-button-group">
                    <?php
                   
                        echo anchor(get_uri("sales_qutation/add_sales"), "<i class='fa fa-plus-circle'></i> " . "Add Sales Quotation", array("class" => "btn btn-default", "title" => "Add Account"));
    ...
    $(document).ready(function () {
        $("#salary-table").appTable({                       
            source: '<?php echo_uri("sales_qutation/list_data") ?>',                      
            columns: [
                {title: '<?php echo "Sales<br />Quotation<br />Number" ?>'},
                {title: '<?php echo "Date" ?>'},
