...
<div class="modal-body clearfix" >
    ...
    <div class="col-md-3"><button id="print-btn" type="button" class="btn btn-default btn-sm " style="margin-bottom:5px"><i class=" fa fa-print"></i> Print</button> </div>  <div class="col-md-6 text-center" > Sales Detail </div>
       ...
       <tr>
          ...
          <td class="w30">Sales Type</td><td class="w60">&nbsp;<?php echo $model_info->sales_type; ?></td>
       </tr>
       <tr>
         <?php
       ...
       <?php
            ...
            $product_sales_data = $this->ProductSalesQuotation->salesquotation_product_list($model_info->id);
       ?>
    ...
    <table class="table table-striped table-bordered">
       ...
       <th class="text-right">Discount</th><th class="text-right">Total</th>
        ...
        <tr>
            ...
            <td class="text-right"><?php  echo $model_info->paid_amount;?></td>    
        </tr>

        <tr>
            <td colspan="7">Due</td>                
            <td class="text-right"><?php  echo ($model_info->grand_total-$model_info->paid_amount);?></td>    
        </tr>
...
<div class="modal-footer">
    ...
    <a href="sales_qutation/edit/<?php echo $model_info->id; ?>">
