...
<div id="page-content" class="m20 clearfix">
  ...
  <div class="panel">
      <div class="tab-title clearfix">
                  <h4><?php echo "Add Sales Quotation"; ?></h4>
      </div>
  
      <div>
      <?php echo form_open(get_uri("sales_qutation/save"), array("id" => "sales-form", "class" => "general-form", "role" => "form")); ?>
      ...
      <div class="row" style="padding:10px">
                                      ...
                                      <div class="col-md-4">
                                          <div class="form-group">
                                              ...
                                              <option value="<?php echo "Job Order" ?>"><?php echo "Job Order"; ?> </option>
                                              <option value="<?php echo "Sales Order" ?>"><?php echo "Sales Order"; ?> </option>
                                              </select>
                                          </div>
                                      </div>
      ...
      $(document).on('click', '.selected', function(){
         ...
         taxall.forEach(function(value,index) {
          ...
          else
          {
              ...
              orderlist += '<td><input  class="form-control qtychange" type="number" name="qty[]" value="1" required=true /></td>';
