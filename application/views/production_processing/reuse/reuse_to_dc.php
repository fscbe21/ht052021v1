...
<div class="p20 panel panel-default">
    ...
    ?>
      <div id="success-alert" class="alert alert-success alert-dismissible">
       ...
       <strong>Success!</strong> DC created successfully.
      </div>
     ...
     <div class="page-title clearfix">
        <h4>DC Outward (Indent)</h4>
        <div class="title-button-group">

        </div>
    </div>
    <br />
    <?php echo form_open(get_uri("production_dc_outward/save"), array("id" => "purchase-form", "class" => "general-form", "role" => "form")); ?>
    <div class="row">
        <div class="col-md-3">
        ...
        <?php
            $outward_data = $this->Dc_outward_model->get_max_id();
        ?>

        <div class="col-md-3">
            <div class="form-group">
                <label for="discount"><?php echo lang('dc_no'); ?></label>
                   <input type="text" value="<?php echo (int)$outward_data->id + 1; ?>" name="dc_no" class="form-control"/>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="date" value="<?= date('Y-m-d'); ?>" name="dc_date" class="form-control"/>
            </div>           
        </div>
        ...
        <div class="col-md-3" id="show_work_order">
            <div class="form-group">
                ...
                <input value="<?= $work_order_data->id; ?>" type="text" id="work-order-no" name="work_order_no" class="form-control" readonly/>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_purchase_number">
            <div class="form-group">
                ...
                <input id="purchase-no" type="text" name="purchase_no" class="form-control"/>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_purchase_date">
            <div class="form-group">
                ...
                <input id="purchase-date" type="date" name="purchase_date" class="form-control"/>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_work_order_date">
            <div class="form-group">
                ...
                <input type="date" value="<?= $work_order_data->date; ?>" id="work-order-date" name="work_order_date" class="form-control" readonly>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_sale_order_number">
            <div class="form-group">
                ...
                <input type="text" value="<?= $work_order_data->sales_order_number; ?>" id="sale-order-number" name="sale_order_number" class="form-control" readonly/>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <select id="from-warehouse" name="from_warehouse" class="form-control">   
                    <?php foreach($warehouse_all as $wh){?>
                        <?php if ($from_warehouse_id == $wh->id){?>
                    <option
            ...
            <div class="form-group">
                <label for="title" ><?php echo 'Shop Keeper Name'; ?></label>
                    <select id="shop-keeper-name" name="shop_keeper_name" class="form-control">   
                        ...
                        <?php foreach($user_all as $wh){?>
                        <option value="<?php echo $wh->id; ?>"><?php echo $wh->first_name.' '.$wh->last_name; ?> </option>
                        <?php }  ?>                                                    
                    </select>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_receiver_name">
            <div class="form-group">
                ...
                <input id="receiver-name" type="text" name="reciever_name" class="form-control"/>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_customer_name">
            <div class="form-group">
                ...
                <select id="customer-name" name="customer_name" class="form-control">   
                    <?php foreach($clients_all as $wh){?>
                    <?php if($wh->id == $work_order_data->customer_id) {?>
                    <option value="<?php echo $wh->id; ?>"><?php echo $wh->company_name; ?> </option>
                    <?php } }  ?>                                                    
                </select>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_vendor_name">
            <div class="form-group">
                ...
                <select id="vendor-name" name="vendor" class="form-control">   
                    <option value="" >Select</option> 
                    <?php foreach($supplier_all as $wh){?>
                    <option value="<?php echo $wh->id; ?>"><?php echo $wh->name; ?> </option>
                    <?php }  ?>                                                    
                </select>
            </div>
        ...
        <div class="col-md-3" id="show_reference_number">
            <div class="form-group">
                ...
                <input id="reference-number" type="text" name="reference_no" class="form-control"/>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_vehicle_number">
            <div class="form-group">
                ...
                <input id="vehicle-number" type="text" name="vehicle_no" class="form-control"/>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_vehicle_name">
            <div class="form-group">
                ...
                <input id="vehicle-name" type="text" name="vehicle_name" class="form-control"/>
            </div>
        </div>
    ...
    <div class="row">                   
        ...
        <div class="col-md-12"> 
            <div class="table-responsive">
                <table id="myTable" class="table table-hover order-list" style="pointer-events:none;">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Code</th>
                    ...
                    <?php 
                       foreach($product_id_array as $key=>$value){
                           ...
                           $product_data = $this->Products_model->get_one($value);
                           ...
                           <tr>
                                ...
                                <td><input style="width: 100px; background-color: white; border: 1px solid #2c3e50" class="form-control qtychange" type="number" name="qty[]" value="<?= $product_qty_array[$key]; ?>" readonly/></td>
                                <td class="unit-name"><?= $unit_name; ?></td>
                                <td style="color: red"><i class="fa fa-trash-o deletethis" aria-hidden="true"></i><input type="hidden" name="code[]" value="<?= $product_code; ?>"/><input type="hidden" name="id[]" value="<?= $product_data->id; ?>"/><input type="hidden" name="product_cost[]" value="<?= $product_data->cost?>"/></td>
                           </tr>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.deletethis', function(){
      ...
      alert('cannot remove this product.');
    });

    $("#success-alert").fadeTo(2000, 500).slideUp(500, function(){
        $("#success-alert").slideUp(500);
        window.setTimeout(function() {
            window.location.href = '<?php echo base_url(); ?>index.php/production_dc_outward';
        }, 400);
    });
