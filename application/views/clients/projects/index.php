            ...
            <div class="page-title clearfix">
                ...
                <div class="title-button-group">
                    ...
                    /* if (isset($can_create_projects) && $can_create_projects) {
                        echo anchor(get_uri("projects/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_project'), array("class" => "btn btn-default", "data-post-client_id" => $client_id, "title" => lang('add_project')));
                    } */
                    ?>
                </div>
            </div>
