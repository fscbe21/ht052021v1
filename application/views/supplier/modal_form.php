...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        <label for="title" class=" col-md-3"><?php echo lang('supplier').' '.lang('name'); ?>*</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                ...
                "class" => "form-control",
                "placeholder" => 'Enter '.lang('supplier').' '.lang('name'),
                "autofocus" => true,
...
<div class="modal-footer">
    ...
    <button type="submit" id="fs-supplier-btn" class="btn btn-primary"><span class="fa fa-check-circle"></span> <?php echo lang('save'); ?></button>
</div>
<?php echo form_close(); ?>
