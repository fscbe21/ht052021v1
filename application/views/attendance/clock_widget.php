    ...
    <div class="panel-body ">
        ...
        <div class="widget-details">
            ...
            if (isset($clock_status->id)) {
                ...
                echo modal_anchor(get_uri("attendance/clock_in_department_data"), "<i class='fa fa-sign-in'></i> " . lang('clock_in'), array("class" => "btn btn-default no-border", "title" => lang('clock_in'), "id"=>"timecard-department-clock-in"));
