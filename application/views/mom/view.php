<div class="message-container-<?php echo $message_info->id; ?>" data-total_messages="<?php echo $found_rows ?>">
                ...
                <div class="media-body w100p">
                    <div class="media-heading clearfix">
                        ...
                        <span class="pull-right dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li role="presentation"><?php echo ajax_anchor(get_uri("mom/delete_my_messages/$message_info->id"), "<i class='fa fa-times'></i> " . lang('delete'), array("class" => "", "title" => lang('delete'), "data-fade-out-on-success" => ".message-container-$message_info->id")); ?> </li>
                            </ul>
                        </span>
                    </div>
                    ...
                    <div class="comment-image-box clearfix">
                        ...
                        if ($total_files) {
                            ...
                            echo anchor(get_uri("mom/download_message_files/" . $message_info->id), $download_caption, array("class" => "pull-right", "title" => $download_caption));
                        }
                        ?>
                    </div>
    ...
    foreach ($replies as $reply_info) {
        ?>
        <?php $this->load->view("mom/reply_row", array("reply_info" => $reply_info)); ?>
    <?php } ?>

    <div id="reply-form-container">
        <div id="reply-form-dropzone" class="post-dropzone">
            <?php echo form_open(get_uri("mom/reply"), array("id" => "message-reply-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <script type="text/javascript">
        ...
        function loadMoreMessages(callback) {
            ...
            $.ajax({
                url: "<?php echo get_uri('mom/view_messages'); ?>",
                type: "POST",
                data: {
