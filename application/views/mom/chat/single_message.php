...
if ($total_files) {
    ...
    $download_caption = anchor(get_uri("mom/download_message_files/" . $reply_info->id), "<i class='fa fa-paperclip pull-left font-16'></i>" . $download_lang, array("class" => "", "title" => $download_lang));
}
