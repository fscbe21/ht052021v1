<div id="page-content" class="clearfix">
 ...
 <!--changes darini 28-3-->
 <li role="presentation"><?php echo anchor(get_uri("invoices/geninvoice/" . $invoice_info->id ), "<i class='fa fa-copy'></i> " . "Generate Invoice", array("title" =>  "Generate Invoice", "target" => "_blank")); ?> </li>
  ...
  <div class="mt15">
            <div class="panel panel-default p15 b-t">
                <div class="clearfix p20">
                    <div id="invoice-extra-info">
                                   
                        <?php $this->load->view("invoices/invoice_extra_info"); ?>
                   </div>
                 </div>   
             </div>
          </div>   <!--end-->
    ...
    $(document).ready(function () {
        ...
        $("#invoice-item-table").appTable({
            ...
            columns: [
                ...
                {title: '<?php echo lang("item") ?> ', "class":"option","bSortable": false},//2-4
                ...
                {title: '<?php echo "Discount" ?>', "class": "text-right w15p", "bSortable": false},//2-4
