...
<!--darini 11-4-->
    <tr>
    <?php  $invoice=$this->Invoices_model->get_one($invoice_id);
           $client=$this->Clients_model->get_one($invoice->client_id);
    ?>
        <td><?php echo "Advance"; ?></td>
        <td><?php echo to_currency($client->total_advance_amount,$invoice_total_summary->currency_symbol); ?></td>      
    </tr>
    <!--end-->
</table>