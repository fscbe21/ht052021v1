...
<div class="panel">
    <div class="tab-title clearfix">
                <h4><?php echo "Edit Sales Return"; ?></h4>
    </div>

    <div>
    <?php echo form_open(get_uri("sale_return/update"), array("id" => "sales-form", "class" => "general-form", "role" => "form")); ?>
    <input type="hidden" name="sale_return_id" value="<?php echo $info->id; ?>"/>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <?php  $product_sales_data = $this->ProductReturn->sales_return_product_list($info->id);
