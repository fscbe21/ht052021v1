...
<div class="modal-body clearfix" >
    ...
    <div class="col-md-3"><button id="print-btn" type="button" class="btn btn-default btn-sm " style="margin-bottom:5px"><i class=" fa fa-print"></i> Print</button> </div>  <div class="col-md-6 text-center" >Sales Return  Detail </div>
       <table class="table table-striped table-bordered">
       
       <tr>
          <td class="w30">Sales Return Reference No</td><td class="w60">&nbsp;<?php echo $model_info->reference_no; ?></td>
       </tr>
       <tr>
          <?php
       ...
       <div class="col-md-12 text-center" >  Sales Return  Products Detail</div>
       

       <?php
            
            $product_sales_data = $this->ProductReturn->sales_return_product_list($model_info->id);
       ?>
...
<div class="modal-footer">
    ...
    <a href="sale_return/edit/<?php echo $model_info->id; ?>">
