...
<div class="panel">
    ...
    <div>
    <?php echo form_open(get_uri("sales_order/update_sales"), array("id" => "sales-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="row" style="padding:10px">
        ...
        <div class="col-md-4"> 
                                        <div class="form-group">
                                            ...
                                            <select  name="sales_quotation" class="selectpicker form-control" disabled="true" >
                                            <option value="" >None</option> 
                                            <?php foreach($quotation as $wh){?>
                                                 <option value="<?php echo $wh->id; ?>" <?php if($info->sales_quotation==$wh->id){?> selected <?php }?> ><?php echo $wh->id; ?> </option>
                                            <?php }  ?>   
                                            </select>
                                        </div>
                                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="purchase_order_number" class="form-control" value="<?php echo $info->purchase_order_number; ?>"/>
                </div>
            </div> 
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label>Date</label>
                    <input type="date" name="sales_order_date" class="form-control" value="<?= $info->sales_order_date; ?>"/>
                </div>
            </div>                                           
        </div>
        <div class="row" style="padding:10px">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <?php  $product_sales_data = $this->ProductSalesOrder->salesorder_product_list($info->id); 
    ...
    $(document).on('keyup', '#search', function(){
       ...
       // var ur="search/"+searchContent;
        ...
        if(searchContent.length != 0){
           ...
           url: '<?= base_url(); ?>index.php/bomcreation/search_end_product/'+searchContent,
            dataType: 'json',
