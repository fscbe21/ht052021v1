            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php                   
                            echo modal_anchor(get_uri("purchase/edit_payment_modal_form/".$info->id."/".$info->purchase_id), "<i class='fa fa-pencil'></i> " , array("class" => "btn btn-default", "title" => "Edit Payment"));                                                                      
                        ?>
                      
                           <!-- <a href="<?php echo  get_uri("purchase/deletePayment/".$info->id )?>" title="Delete Payment" class="delete"  ><i class="fa fa-times fa-fw"></i> </a>-->
...
function confirmPaymentDelete(id){
   if (confirm("Are you sure want to delete? If you delete this money will be refunded.")) {
    ...
    $.ajax({
            type: 'GET',
            url:  '<?php echo  get_uri("purchase/deletePayment/" )?>'+id,                  
