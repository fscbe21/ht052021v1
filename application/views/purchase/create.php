...
<div id="page-content" class="p20 clearfix">
    ...
    ?>
      <div id="success-alert" class="alert alert-success alert-dismissible">
       ...
       <strong>Success!</strong> Purchase created successfully.
      </div>
        ...
        <div class="">
            <div class="panel panel-default">
                <div class="page-title clearfix">
                    <h4> <?php echo lang('add_purchase'); ?></h4>
                ...
                <br />
                <?php echo form_open(get_uri("purchase/savepurchase"), array("id" => "purchase-form", "class" => "general-form", "role" => "form")); ?>
                ...
                <div class="container row">
                    ...
                    <div class="col-md-5" >
                        <div class="form-group">
                            <label for="title" class=" col-md-3">Select GRN id</label>
                            <div class="<?php echo $field_column; ?>">
                                <div class=" col-md-9">
                  ...
                  <!--end-->                                        
                         <!--darini 22-3-->                                        
                         <div class="col-md-5" style="display:none"><!--changes 10-4 darini-->
                        <div class="form-group">
                    ...
                    <table id="myTable" class="table table-hover order-list" style="width: 80%">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Code</th>
                                <th align="right">Quantity to be Received</th>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.selected', function(){
        ...
        else
        {
            ...
            orderlist += '<td ><input class="cost" type="text" value="'+cost+'"/></td>';
            ...
            orderlist += '<input type="hidden" name="product_cost[]" class="product_cost" value="'+cost+'"/>';
    ...
    //darini 10-4
$('select[name="grn_id"]').on("change", function() {
