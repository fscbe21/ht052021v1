        ...
        <div class="col-sm-9 col-lg-10">
            ...
            <div class="panel panel-default no-border clearfix ">
                ...
                <ul id="integration-tab" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
                    ...
                    <li><a role="presentation" class="" href="<?php echo_uri("settings/sms/"); ?>" data-target="#integration-sms">SMS</a></li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="integration-sms"></div>
                </div>
            </div>
        </div>
    </div>
