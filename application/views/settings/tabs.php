...
$settings_menu = array(
    ...
    "setup" => array(
        ...
        array("name" => "other_settings", "url" => "other_settings"),
    ...
    "logs" => array(
        ...
        array("name" => "login_duration", "url" => "logs"),
...
$settings_menu["setup"][] = array("name" => "production", "url" => "production");//R.V15_03

$settings_menu["setup"][] = array("name" => "department", "url" => "department");
//AG010321 - start
$settings_menu["setup"][] = array("name" => "warehouse", "url" => "warehouse");
/*AG040321*/
$settings_menu["setup"][] = array("name" => "empgroup", "url" => "empgroup");
/*AG040321*/
$settings_menu["setup"][] = array("name" => "brand", "url" => "brand");
$settings_menu["setup"][] = array("name" => "unit", "url" => "unit");
$settings_menu["setup"][] = array("name" => "supplier", "url" => "supplier");
$settings_menu["setup"][] = array("name" => "vendor", "url" => "vendor");
$settings_menu["setup"][] = array("name" => "customergroup", "url" => "customergroup");
$settings_menu["setup"][] = array("name" => "biller", "url" => "biller");
$settings_menu["setup"][] = array("name" => "customer", "url" => "customer");
$settings_menu["setup"][] = array("name" => "barcodesymbology", 
                                  "url"  => "barcodesymbology");
$settings_menu["setup"][] = array("name" => "producttype","url"  => "producttype");
