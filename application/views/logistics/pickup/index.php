            ...
            <div class="tab-title clearfix">
                ...
                <div class="title-button-group">
                    <?php
                        ...
                        echo modal_anchor(get_uri("pickup/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_number'), array("class" => "btn btn-default", "title" => lang('add_number')));
   ...
   // echo modal_anchor(get_uri("noc/modal_form_client"), "<i class='fa fa-plus-circle'></i> " . lang('add_noc_for_client'), array("class" => "btn btn-default", "title" => lang('add_department')));
    ...
    $(document).ready(function () {
        $("#salary-table").appTable({                       
            source: '<?php echo_uri("pickup/list_data/") ?>',                      
            columns: [
                {title: '<?php echo "SL" ?>', "class": ""},
               
                {title: '<?php echo "Pickup  Number" ?>'},
