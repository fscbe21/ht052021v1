...
<!-- AG2302 start-->
<div class="form-group">
        <label for="reason" class=" col-md-3">Date of return from Last Leave:</label>
        <div class=" col-md-9">
            <?php
             echo form_input(array(
                "id" => "date_of_last_leave_return",
                "name" => "last_return_date",
                "class" => "form-control",
                "placeholder" => "Select date of return from last leave"
            ));
            ?>
        </div>
    </div>
    <div class="form-group">
        <label for="reason" class=" col-md-3">Period of Last Leave:</label>
        <div class=" col-md-9">
            <?php
             echo form_input(array(
                "id" => "period_of_last_leave",
                "name" => "period_of_last_leave",
                "class" => "form-control",
                "placeholder" => "Enter period of last leave"
            ));
            ?>
        </div>
    </div>
     ...
     <!-- AG2402 START-->
     <div class="form-group">
        <label for="leave_type" class=" col-md-3">Last Leave Type</label>
        <div class=" col-md-9">
            <?php
            echo form_dropdown("last_leave_type_id", $leave_types_dropdown, "", "class='select2'");
            ?>
        </div>
    </div>
    <!-- AG2402 END-->
    ...
    <div class="form-group">
        <label for="reason" class=" col-md-3">Leave Address</label>
        <div class=" col-md-9">
            <?php
            echo form_textarea(array(
                ...
                "name" => "leave_address",
                "class" => "form-control",
                "placeholder" => 'Enter leave address'
            ));
            ?>
        </div>
    </div>
    <div class="form-group">
        <label for="reason" class=" col-md-3">Performing person during leave:</label>
        <div class=" col-md-9">
            <?php
             echo form_input(array(
                "id" => "person_name",
                "name" => "performing_person_name",
                "class" => "form-control",
                "placeholder" => "Enter Performing person during leave"
            ));
            ?>
        </div>
    </div>
