...
<!-- AG2402 START-->
                <tr>
                    <td> Created at</td>
                    <td><?php echo $leave_info->created_at; ?></td>
                </tr>
                <tr>
                    <td>Performimg person name</td>
                    <td><?php echo $leave_info->performing_person_name; ?></td>
                </tr>
                <tr>
                    <td>Leave address</td>
                    <td><?php echo $leave_info->leave_address; ?></td>
                </tr>
<!-- AG2402 END-->
