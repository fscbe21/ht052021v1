...
<div class="modal-body clearfix">
    <div class="table-responsive" id="purchase_details">    <button id="print-btn" type="button" class="btn btn-default btn-sm " style="margin-bottom:5px"><i class=" fa fa-print"></i> Print</button> 
     Purchase Order Detail<br /> <br />        
      ...
      <!--changes22-3-->
      <tr>
          <td class="w30">Purchase Order No</td><td class="w60">&nbsp;<?php echo $model_info->po_no; ?></td>
       </tr>
       <tr>
         
          <td class="w30">Quotation Number</td><td class="w60">&nbsp;<?php echo  $model_info->quotation_number; ?></td>
       </tr>
       <tr>
        
          <td class="w30">Purchase Requisition Number</td><td class="w60">&nbsp;<?php echo $model_info->purchase_requstion_number; ?></td>
       </tr><!--end-->
       <tr>
       <?php
       ...
       <?php
          $options = array();
          $options['purchase_order_id'] = $model_info->id;//changes 22-3
         // $product_purchase_data = $this->Productpurchase_model->get_details($options)->result();
         $product_purchase_data = $this->Purchaseorder_details_model->get_details($options)->result();//changes 22-3
       ?>
