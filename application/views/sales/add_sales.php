...
<div class="panel">
    <div class="tab-title clearfix">
                <h4><?php echo lang("add_sales"); ?></h4>
    </div>

    <div>
    <?php echo form_open(get_uri("sales/save"), array("id" => "sales-form", "class" => "general-form", "role" => "form")); ?>
        ...
        <div class="row" style="padding:10px">
                            <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select  name="sales_order" class="selectpicker form-control"  >
                                            <option value="" >Select Number</option> 
                                            <?php foreach($order as $wh){?>
                                                 <option value="<?php echo $wh->id; ?>"><?php echo $wh->id; ?> </option>
                                            <?php }  ?>   
                                            </select>
                                        </div>
                                    </div>                                           
...
<script type="text/javascript">
    ...
    if (payment_status == 3 || payment_status == 4) {
        ...
        if(payment_status == 4){
            ...
            $("#paid-amount").attr('readonly',false);
        }
    }else{
...
$('#sales-form').on('submit',function(e){
  ...
  //darini25-3
  $('select[name="sales_order"]').on("change", function() {
        var warehouse_id = $('#warehouse_id').val();     
        if(!warehouse_id){
            alert("Please Select Warehouse");
            $('select[name="sales_order"]').val('');
        }else{ 
         var req=$(this).val();
