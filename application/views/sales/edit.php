...
<div class="panel">
    ...
    <div>
    <?php echo form_open(get_uri("sales/update_sales"), array("id" => "sales-form", "class" => "general-form", "role" => "form")); ?>
        ...
        <div class="row" style="padding:10px">
                            <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select  name="sales_order" class="selectpicker form-control" disabled="true" >
                                            <option value="" >Select Number</option> 
                                            <?php foreach($order as $wh){?>
                                                 <option value="<?php echo $wh->id; ?>"  <?php if($info->sales_order==$wh->id){?> selected <?php }?> ><?php echo $wh->id; ?> </option>
                                            <?php }  ?>   
                                            </select>
                                        </div>
                                    </div>                                           
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <?php  $product_sales_data = $this->ProductSales->sales_product_list($info->id); 
                                                ...
                                                foreach($product_sales_data as $bdata){
                                                    ...
                                                    ?>
                                                          <tr>
                                                            ...
                                                            <td class="cost"><?php echo  $bdata->net_unit_price?></td>
                                                            ...
                                                            <td style="color: red"><i class="fa fa-trash-o deletethis" aria-hidden="true"></i>
                                                                    ...
                                                                    <input type="hidden" name="product_cost[]" value="<?php echo  $bdata->net_unit_price?>"/>
                                    ...
                                    <div class="col-md-4"  style="display:none" >
                                        <div class="form-group">
                                            ...
                                            <select name="payment_status" class="form-control">
                                                <option value="1" <?php if($info->payment_status==1){?> selected <?php }?>>Pending</option>
                                                <option value="2" <?php if($info->payment_status==2){?> selected <?php }?>>Due</option>
                                                <option value="3" <?php if($info->payment_status==3){?> selected <?php }?>>Partial</option>
                                                <option value="4" <?php if($info->payment_status==4){?> selected <?php }?>>Paid</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div id="payment" style="padding:10px;display:none">
                                    <div class="row" >
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Paid By</label>
