...
<div class="panel">
    <div class="tab-title clearfix">
                <h4><?php echo "Edit Purchase Return"; ?></h4>
    </div>

    <div>
    <?php echo form_open(get_uri("purchase_return/update"), array("id" => "sales-form", "class" => "general-form", "role" => "form")); ?>
    <input type="hidden" name="purchase_return_id" value="<?php echo $info->id; ?>"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="">Select Supplier</option> 
                                                <?php foreach($supplier_all as $sp){?>
                                                    <option value="<?php echo $sp->id; ?>" <?php if($info->supplier_id==  $sp->id){?> selected <?php }?> ><?php echo $sp->name.' ( '.$sp->company_name.' )'; ?> </option>
                                                    <?php }  
                                                    ?>                                                    
                                        </select>                                            
                                        </div>
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <?php
                                                    ...
                                                    $product_sales_data = $this->ProductPurchaseReturn->purchase_return_product_list($info->id);
         ...
         <div class="row mt-3" style="padding:10px">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="account_id" required>                                                
                                                ...
                                                <?php foreach($accounts as $tx){?>
                                                    <option value="<?php echo $tx->id; ?>" <?php if($tx->id==$info->account_id){ ?> selected <?php }?> ><?php echo $tx->name; ?> </option>
                                                <?php }  ?>                                                 
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div  class="col-md-6">
                                         <div class="form-group">
                                            ...
                                            <textarea rows="6" class="form-control" name="return_note"><?php echo $info->return_note; ?></textarea>
                                        </div>
                                </div>
                                <div  class="col-md-6">
                                        <div class="form-group">
