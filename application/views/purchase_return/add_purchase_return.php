...
<div class="panel">
    ...
    <div>
    <?php echo form_open(get_uri("purchase_return/save"), array("id" => "sales-form", "class" => "general-form", "role" => "form")); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="">Select Supplier</option> 
                                                <?php foreach($supplier_all as $sp){?>
                                                    <option value="<?php echo $sp->id; ?>"><?php echo $sp->name.' ( '.$sp->company_name.' )'; ?> </option>
                                                    <?php }  
                                                    ?>                                                    
                                        </select>                                            
                                        </div>
