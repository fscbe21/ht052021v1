<div id="page-content" class="clearfix p20">
    <div class="panel clearfix">
        <ul id="expenses-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            <li class="title-tab"><h4 class="pl15 pt10 pr15"><?php echo lang("expense_approval"); ?></h4></li>
           ...
           <!-- <li><a role="presentation" href="<?php echo_uri("expenses/recurring/"); ?>" data-target="#recurring-expenses"><?php echo lang('recurring'); ?></a></li>
            ...
            <div class="tab-title clearfix no-border" style="display: none;">
...
<script type="text/javascript">
    loadExpensesTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("expenses_approval/list_data") ?>/' + recurring,
            ...
            columns: [
                ...
                {title: '<?php echo "Name" ?>'},
                {title: '<?php echo "Expenses" ?>'},
                {title: '<?php echo "From" ?>'},
                {title: '<?php echo "To" ?>'},
                {title: '<?php echo "Total" ?>'},
                {title: '<?php echo "Other Expense" ?>'},
                {title: '<?php echo "Submit Date" ?>'},
                {title: '<?php echo "Team Member" ?>'},//darini 18-2
