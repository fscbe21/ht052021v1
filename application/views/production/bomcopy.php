...
<div id="page-content" class="p20 clearfix">
    ...
    ?>
      <div id="success-alert" class="alert alert-success alert-dismissible">
       ...
       <strong>Success!</strong>&nbsp;Bom cloned / created successfully.
      </div>
      ...
      <?php
        ...
        <div class="">
            <div class="panel panel-default">
                ...
                <br />
                <?php echo form_open(get_uri("bomcreation/copyandcreatebom"), array("id" => "bom-update-form", "class" => "general-form", "role" => "form")); ?>
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <div class="<?php echo $field_column; ?>">
                                <div class=" col-md-9">
                                  <input required id="bom-name" type="text" class="form-control" name="bom_name" placeholder="Enter BOM Name"
                                  value=""/> 
                                </div>
                            </div>
                        </div>
                    ...
                    <table id="myTable" class="table table-hover order-list" style="width: 80%">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><input readonly style="width: 100px;" class="form-control qtychange" type="text" name="qty[]" value="<?php echo $bomdetail->product_qty; ?>"/></td>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.selected', function(){
        ...
        else
        {
            ...
            //orderlist += '<td><input style="width: 100px; background-color: white; border: 1px solid #2c3e50" class="form-control qtychange1 qtychng" type="text" name="quantity[]" value="0.000"/></td>';
