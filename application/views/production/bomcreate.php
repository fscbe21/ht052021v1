...
<div id="page-content" class="p20 clearfix">
    ...
    ?>
      <div id="success-alert" class="alert alert-success alert-dismissible">
       ...
       <strong>Success!</strong> BOM created successfully.
      </div>
      ...
      <?php
        ...
        <div class="">
            <div class="panel panel-default">
                ...
                <br />
                <?php echo form_open(get_uri("bomcreation/savebomcreation"), array("id" => "bom-creation-form", "class" => "general-form", "role" => "form")); ?>
                <div class="container row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <div class="<?php echo $field_column; ?>">
                                <div class=" col-md-9">
                               <!--  AG2703QQQ --> <input id="bom-name" required type="text" class="form-control" name="bom_name" placeholder="Enter BOM Name"/> 
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <div class="<?php echo $field_column; ?>">
                                <div class=" col-md-9">
                                 <input type="text" id="end-product-id" name="end_product_id" class="form-control" required>   
                            <div id="end-product-list"></div>                                       
                                </div>
                            </div>
                        </div>
...
<!--                                 <th>Quantity</th> -->
              ...
              <br />
              <br />
              <div class="container p-2"><!-- AG2703QQQ -->
                 <input type="submit" value="Submit" onclick="return checkproduct()" name="submit" class="btn btn-md btn-primary"/> 
             </div><br />
             <br />
              <?php echo form_close(); ?>                          
            </div>
...
<script type="text/javascript">
    ...
    var selectedEndProductFromList = 0;
    totalProductsCount = $('#myTable tr').length;
    ...
    $(document).on('keyup', '#search', function(){
        ...
        var endProdId = $('#bom-product-type').val();
        if(selectedEndProductFromList == 1){
        if(searchContent.length != 0){
            $.ajax({
            type: 'GET',
            url: '<?php echo base_url(); ?>index.php/bomcreation/search/'+searchContent+'/'+endProdId,
            dataType: 'json',
        ...
        alert("Please select end product name from list !");
        $('#end-product-id').val('').focus();
    }
    });
    ...
    $(document).on('click', '.selected', function(){
        ...
        else
        {
            ...
            orderlist += '<td><input style="width: 100px;" readonly class="form-control qtychange" type="text" name="qty[]" value="0"/></td>';
            orderlist += '<td class="unit-name"></td>';
            //orderlist += '<td><input style="width: 100px; background-color: white; border: 1px solid #2c3e50" class="form-control qtychange1 qtychng" type="text" name="quantity[]" value="0"/></td>';
            orderlist += '<td><input style="width: 100px; background-color: white; border: 1px solid #2c3e50" class="form-control qtychange2 qtychng" type="text" name="weight[]" value="0"/></td>';
            orderlist += '<td><input style="width: 100px; background-color: white; border: 1px solid #2c3e50" class="form-control qtychange3 qtychng" type="text" name="wastage[]" value="0"/></td>';
            ...
            totalProductsCount += 1;/* AG2703QQQ */
        }
    ...
    function checkproduct(){/* AG2703QQQ */
        if(totalProductsCount == 1){
            window.alert('Please add one or more products !');
            return false;
        }else{
            return true;
        }
