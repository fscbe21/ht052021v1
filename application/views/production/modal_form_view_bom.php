...
<div class="modal-body clearfix">
    ...
    <table class="table table-striped table-bordered">
       <tr>
       <th class="text-center">Sno</th><th>Name</th><th class="text-center">Total Quantity</th><th class="text-center">Unit</th><!-- <th class="text-right">Quantity</th> --><th class="text-right">Weight</th><th class="text-right">Wastage</th>
       </tr>
...
<div class="modal-footer">
    ...
    <a href="<?= base_url(); ?>index.php/bomcreation/editbom/<?php echo $model_info->id; ?>">
        <button type="button" class="btn btn-primary"><span class="fa fa-pencil"></span>&nbsp;Edit</button>
    </a>

    <a href="<?= base_url(); ?>index.php/bomcreation/copybom/<?php echo $model_info->id; ?>">
