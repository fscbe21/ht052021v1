    ...
    <div class="row">
        ...
        <div class="col-md-3" id="show_work_order">
            <div class="form-group">
                ...
                <input value="<?= $wo_info->id; ?>" type="text" id="work-order-no" name="work_order_no" class="form-control" readonly/>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_work_order_date">
            <div class="form-group">
                ...
                <input type="date" value="<?= $wo_info->date; ?>" id="work-order-date" name="work_order_date" class="form-control" readonly>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_sale_order_number">
            <div class="form-group">
                ...
                <input type="text" value="<?= $wo_info->sales_order_number; ?>" id="sale-order-number" name="sale_order_number" class="form-control" readonly/>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_customer_name">
            <div class="form-group">
                ...
                <select id="customer-name" name="customer_name" class="form-control">   
                    ...
                    <?php if($wh->id == $wo_info->customer_id) {?>
        ...
        <div class="col-md-3" id="show_vendor_name">
            <div class="form-group">
                ...
                <select id="vendor-name" name="vendor" class="form-control">   
                    <option value="" >Select</option> 
                    <?php foreach($supplier_all as $va){?>
                    <option
                    <?php
                    $indent_data = array();
                    $indent_data = $this->Indent_model->get_one($indent_id);
                    echo ($indent_data->vendor_id == $va->id) ? ' selected' : '';

                    ?> value="<?php echo $va->id; ?>"><?php echo $va->name; ?> </option>
                    <?php }  ?>                                                    
                </select>
            </div>
        </div>
                ...
                <table id="myTable" class="table table-hover order-list" >
                    ...
                    <?php 
                       foreach($item_data as $idata){
                           $product_data = $this->Products_model->get_one($idata->product_id);
                           ...
                           <tr>
                                ...
                                <td><input style="width: 100px; background-color: white; border: 1px solid #2c3e50" class="form-control qtychange" type="number" name="qty[]" value="<?= $idata->qty; ?>" readonly/></td>
