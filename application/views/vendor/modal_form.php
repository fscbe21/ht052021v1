<?php echo form_open(get_uri("vendor/save"), array("id" => "supplier-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="id" value="<?php echo $model_info->id; ?>" />
    <div class="form-group">
        <label for="title" class=" col-md-3"><?php echo lang('vendor_name'); ?>*</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                ...
                "class" => "form-control",
                "placeholder" => 'Enter '.lang('vendor_name'),
                "autofocus" => true,
