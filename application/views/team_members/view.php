...
<div id="page-content" class="clearfix">
    ...
    <ul id="team-member-view-tabs" data-toggle="ajax-tab" class="nav nav-tabs" role="tablist">
        ...
        <?php } ?>
        <?php if($this->login_user->is_admin || get_array_value($this->login_user->permissions, "download_proof") == "all"){ ?>
        <li><a role="presentation" href="<?php echo_uri("team_members/proof_download/" . $user_info->id); ?>" data-target="#proof-download">Proof Download</a></li>
        <?php } ?>
    </ul>
    ...
    <div class="tab-content">
        ...
        <?php if($this->login_user->is_admin || get_array_value($this->login_user->permissions, "download_proof") == "all"){ ?>
         <div role="tabpanel" class="tab-pane fade" id="proof-download"></div>
        <?php } ?>
    </div>
</div>
