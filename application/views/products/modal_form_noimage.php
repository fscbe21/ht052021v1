<?php echo form_open(get_uri("products/save_noimage"), array("id" => "products-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        ...
        <div class=" col-md-9">
            <input type="text" name="code" class="form-control" id="code" value="<?php echo $model_info->code ? $model_info->code : get_random_number() ?>" placeholder="Enter product code" readonly/>
        </div>
    </div>
...
<div class="modal-footer">
    ...
    <button type="submit" id="fs-product-btn" class="btn btn-primary"><span class="fa fa-check-circle"></span> <?php echo lang('save'); ?></button>
</div>
<?php echo form_close(); ?>
