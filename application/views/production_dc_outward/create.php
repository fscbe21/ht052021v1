...
<div class="p20 panel panel-default">
    ...
    ?>
     ...
     <div class="page-title clearfix">
        <h4> <?php echo lang('dc_outward_add'); ?></h4>
    ...
    <div class="row">
        ...
        <div class="col-md-3" id="show_work_order">
            <div class="form-group">
                ...
                <input type="text" id="work-order-no" name="work_order_no" class="form-control"/>
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_work_order_date">
            <div class="form-group">
                ...
                <input type="date" id="work-order-date" name="work_order_date" class="form-control">
            </div>
        </div>
        ...
        <div class="col-md-3" id="show_sale_order_number">
            <div class="form-group">
                ...
                <input type="text" id="sale-order-number" name="sale_order_number" class="form-control"/>
            </div>
        </div>
