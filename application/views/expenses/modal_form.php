...
<div id="expense-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        ...
        <div class=" form-group">
            <label for="title" class=" col-md-3"><?php echo "Name"; ?></label>
            <div class="col-md-9">
                <?php
        ...
        <div class="form-group">
            <label for="category_id" class=" col-md-3"><?php echo "Expenses"; ?></label>
            <div class=" col-md-9">
                <?php
        ...
        <div class=" form-group">
            <label for="vehicle_type" class=" col-md-3"><?php echo "Vehicle Type"; ?></label>
            <div class="col-md-9">
                <?php
                echo form_input(array(
                    "id" => "vehicle_type",
                    "name" => "vehicle_type",
                    "value" => $model_info->vehicle_type,
                    "class" => "form-control",
        ...
        <div class=" form-group">
            <label for="from_km" class=" col-md-3"><?php echo "From"; ?></label>
            <div class="col-md-9">
                <?php
                echo form_input(array(
                    "id" => "from_km",
                    "name" => "from_km",
                    "value" => $model_info->from_km,
                    "class" => "form-control",
                    "placeholder" => "From",
        ...
        <div class=" form-group">
            <label for="to_km" class=" col-md-3"><?php echo "To"; ?></label>
            <div class="col-md-9">
                <?php
                echo form_input(array(
                    "id" => "to_km",
                    "name" => "to_km",
                    "value" => $model_info->to_km,
                    "class" => "form-control",
                    "placeholder" => "To",
        ...
        <div class="form-group">
            <label for="title" class=" col-md-3"><?php echo "Total"; ?></label>
            <div class=" col-md-9" >
                <?php
                echo form_input(array(
                    "id" => "amount",
                    "name" => "amount",
                    "value" => $model_info->amount_approval ? to_decimal_format($model_info->amount_approval) : "",//darini 18-2
                    "class" => "form-control",
                    "placeholder" => "Total",
                    "autofocus" => true,
                    "data-rule-required" => true,
                    "data-msg-required" => lang("field_required"),
                    "readonly"=>true//darini 18-2
        ...
        <div class=" form-group">
            <label for="time" class=" col-md-3"><?php echo "Time"; ?></label>
            <div class="col-md-9">
                <?php
                echo form_input(array(
                    "id" => "time",
        ...
        <div class=" form-group">
            <label for="other_expense" class=" col-md-3"><?php echo "Other Expense"; ?></label>
            <div class="col-md-9">
                <?php
                echo form_input(array(
                    "id" => "other_expense",
                    "name" => "other_expense",
                    "value" => $model_info->other_expense,
                    "class" => "form-control",
        ...
        <div class=" form-group">
            <label for="vehicle_no" class=" col-md-3"><?php echo "Vehicle No"; ?></label>
            <div class="col-md-9">
                <?php
                echo form_input(array(
                    "id" => "vehicle_no",
                    "name" => "vehicle_no",
                    "value" => $model_info->vehicle_no,
                    "class" => "form-control",
        ...
        <div class="form-group">
            ...
            <div class="col-md-9" style="pointer-events: none;"><!--darini 18-2-->
                <?php
               // echo form_dropdown("expense_user_id", $members_dropdown, $model_info->user_id, "class='select2 validate-hidden' id='expense_user_id'");
               echo form_dropdown("expense_user_id",$members_dropdown, array($this->login_user->id), "class='select2 validate-hidden' id='expense_user_id' ");
                ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#to_km ").on("keyup", function() {
            var v = this.value;
            var from=document.getElementById('from_km').value;
            document.getElementById('amount').value=parseFloat(v)-parseFloat(from);
            console.log(v);
        });

        $("#from_km ").on("keyup", function() {
            var v = this.value;
            console.log("enterf");
            var to=document.getElementById('to_km').value;
            document.getElementById('amount').value=parseFloat(to)-parseFloat(v);
            console.log(v);
        });
    //end
